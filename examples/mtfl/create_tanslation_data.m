...
%       I(:, :, 1) = (im(:, :, 3) - im_mean(:, :, 1))';
      ...
      landmark(1:5) = landmark(1:5);
      landmark(6:10) = landmark(6:10);
      landmark(1:5) = landmark(1:5) / w + 1 / 8;
      landmark(6:10) = landmark(6:10) / h + 1 / 20;
      
      batch_landmark(:, i) = landmark;
      attributes = cellfun(@str2num, txt(12:15)) - 1;
      attributes(1, 4) = 4 - attributes(1, 4);
      batch_attributes(:, i) = attributes;
  end
  % store to hdf5
