...
caffe_root = '/home/ytoon/caffe/'
import sys
sys.path.insert(0, caffe_root + 'python')

image_path = '/media/ytoon/Elements/mtfl/dataset_test/_60_2574_0.jpg'
net = caffe.Net(caffe_root + 'models/mtfl/deploy.prototxt',
                caffe_root + 'models/mtfl/caffe_mtflnet_train_iter_20000.caffemodel',
                caffe.TEST)
